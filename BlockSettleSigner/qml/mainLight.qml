...
//    minimumHeight: 600
    ...
    function customDialogRequest(dialogName, data) {
        ...
        prepareLigthModeDialog(newDialog)
...
//        })
    ...
    function invokeQmlMetod(method, cppCallback, argList) {
        ...
        var jsCallback = function(cbArg0, cbArg1, cbArg2, cbArg3, cbArg4, cbArg5, cbArg6, cbArg7){
            console.log("invokeQmlMetod callback")
