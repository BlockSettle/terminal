...
void BSTerminalMainWindow::GetNetworkSettingsFromPuB(const std::function<void()> &cb)
{
   ...
   const auto &populateAppSettings = [this](NetworkSettings settings) {
      ...
      applicationSettings_->set(ApplicationSettings::chatServerHost, QString::fromStdString("192.168.0.106"));
      applicationSettings_->set(ApplicationSettings::chatServerPort, 9400);
   };
