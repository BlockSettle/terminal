...
void BSTerminalMainWindow::onLogin()
{
   ...
   connect(ui_->widgetRFQ, &RFQRequestWidget::cancelTrade, bsClient_.get(), &BsClient::sendCancelOnATrade);
   ...
   connect(ui_->widgetRFQReply, &RFQReplyWidget::cancelTrade, bsClient_.get(), &BsClient::sendCancelOnATrade);
