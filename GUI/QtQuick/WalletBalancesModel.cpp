...
QVariant WalletBalancesModel::data(const QModelIndex& index, int role) const
{
   ...
   case WalletBalance::TotalRole:
      ff = [](const Balance& bal) { return gui_utils::normalized_balance_to_qstring(bal.total); };
      break;
   case WalletBalance::ConfirmedRole:
      ff = [](const Balance& bal) { return gui_utils::normalized_balance_to_qstring(bal.confirmed); };
      break;
   case WalletBalance::UnconfirmedRole:
      ff = [](const Balance& bal) { return gui_utils::normalized_balance_to_qstring(bal.unconfirmed); };
      break;
