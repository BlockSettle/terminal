    ...
    try
    {
        ...
        case TableDataRole:
            ...
            else
            {
                ...
                case 1:
                    return QString::number(pendingBalances_.at(addresses_.at(row).id()).nbTx);
                case 2:
                    return QString::number(pendingBalances_.at(addresses_.at(row).id()).balance / BTCNumericTypes::BalanceDivider, 'f', 8);
                case 3:
                    return table_.at(row).at(1);
                default:
                    return QString{};
                }
            }
        ...
        case AddressTypeRole:
            return table_.at(index.row() - 1).at(2);
        default:
            break;
        }
    }
